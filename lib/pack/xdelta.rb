module Pack
  class XDelta
    ...
    private def remaining_bytes(pos)
    ...
    private def match_from(pos, remaining)
      s, t = pos, @offset
    ...
    private def expand_match(m_offset, m_size)
